...
class File {
    ...
    async moveToDisk(location, options, diskName) {
        ...
        const fileName = options?.name || `${helpers_1.cuid()}.${this.extname}`;
        /**
         ...
         */
        const key = slash_1.default(path_1.join(location || './', fileName));
        /**
        ...
        await driver.putStream(key, fs_extra_1.createReadStream(this.tmpPath), options);
